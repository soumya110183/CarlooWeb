    ...
    <section className="w-full max-w-[1200px] flex items-center mx-auto justify-between text-white pb-32">
      <div className="w-full max-w-[570px]">
        ...
        <div className="grid grid-cols-2 w-full gap-5 mt-6">
          <MissionFeatures  title={"Data Monitoring"} para={"Ensuring that AI systems are understandable and explainable"}>
            <FaMagnifyingGlass size={25} color="black" />
          </MissionFeatures>
          <MissionFeatures  title={"Champion fairness"} para={"Detecting and mitigating biases in data and algorithms"}>
            <FaBalanceScale size={25} color="black" />
          </MissionFeatures>
          <MissionFeatures  title={"Build trust"} para={"Helping organizations gain stakeholder confidence and user loyalty."}>
            <FaHandshake size={25} color="black" />
          </MissionFeatures>
          <MissionFeatures  title={"Safeguard privacy"} para={"Protecting sensitive data in compliance with international standards."}>
