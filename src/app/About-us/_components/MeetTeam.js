...
export default function MeetTeam() {
  return (
    <section className="w-full max-w-[1200px]  mx-auto  text-white pb-32">
      ...
      <div className=" mt-10 mx-auto flex flex-col gap-11">
        <TeamContainer
          img={"StevePhoto.png"}
          name={"Stephen Antony Venansious"}
          role={"Founder & Developer of Algorethics AI Library"}
          details={
            "Stephen Antony Venansious is a highly accomplished technology entrepreneur, data scientist, and the visionary behind the Algorethics AI Library. Drawing inspiration from the Rome Call for AI Ethics, Stephen developed this groundbreaking AI library to ensure that ethical principles are embedded into AI systems from the ground up.His expertise spans across mobile security, cross-platform development, cybersecurity, and digital media rights enforcement, making him a sought-after technology consultant for multinational IT vendors.Stephen's experience founding multiple successful global IT companies—specializing in mobility, augmented reality, and web development—positions him as a leader in the ethical AI space. His work in digital media rights enforcement for industries such as Bollywood and Hollywood further demonstrates his commitment to protecting intellectual property and enforcing fairness in technology. With a background in developing e-commerce platforms and contributing to open-source projects, Stephen's profound understanding of AI has led him to champion ethical AI development. His belief in fairness, transparency, and accountability in AI across industries such as healthcare, finance, and law enforcement makes him the ideal person to drive Algorethics' mission forward."
          }
        />
        <TeamContainer
          ...
          details={
            "Robert McNamara is a forward-thinking technologist and ethical innovator, perfectly suited to lead the charge at Algorethics as its Co-Founder and Chief Ethical Innovation Officer. With a deep-rooted commitment to human-first technological solutions, Robert’s pioneering work includes the invention of Triggersmart, a globally recognized childproof smart gun that uses RFID technology to ensure that only authorized users can fire the weapon. This innovation addresses a critical global issue—preventing thousands of accidental firearm injuries and deaths each year, particularly among children.Robert's drive to create technology that serves humanity responsibly aligns seamlessly with the core mission of Algorethics. His passion for ethical AI development, combined with his track record of creating life-saving, socially impactful technologies, makes him the ideal advocate for promoting fairness, transparency, and ethical accountability in AI. His vision for Algorethics is to ensure that AI not only advances society but does so in a way that safeguards human values and ethical integrity."
          }
        />
        <TeamContainer
          img={"drlevan.jpg"}
          ...
          details={
            "Dr. Levan Bodzashvili is a leading expert in cyberlaw, AI governance, and public policy, with over 20 years of experience in government positions, advisory roles, and academia. His extensive background in AI regulation and compliance makes him an indispensable part of Algorethics' leadership team.Dr. Bodzashvili serves as the Chair of Neiron Academy, an institution committed to advancing artificial intelligence for the benefit of humanity. He firmly believes that AI governance frameworks must promote fairness, transparency, and accountability, ensuring that technology serves the common good. In his role as Governmental Relations and AI Compliance Officer at Algorethics, Dr. Bodzashvili bridges the gap between AI ethics and public policy, advising governments and enterprises on compliant AI deployment. He is passionate about ensuring that AI governance strategies align with regional laws, cultural norms, and global standards. His expertise in regulatory frameworks allows Algorethics to adapt its AI solutions to meet local and regional compliance requirements, promoting ethical AI deployment globally."
          }
        />
        <TeamContainer
