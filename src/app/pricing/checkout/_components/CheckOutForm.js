        ...
        <form className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <div className="flex-1 relative">
              ...
              <button
                type="button"
                className="absolute right-3 top-1/2 transform -translate-y-1/4 text-gray-400 hover:text-gray-600"
              >
                {/* SVG for eye icon */}
                <svg
                ...
                >
                  ...
                  <path
                    fillRule="evenodd"
                    d="M1.323 11.447C2.811 6.976 7.027 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.487 4.471-5.702 7.697-10.675 7.697-4.97 0-9.186-3.223-10.675-7.69a1.096 1.096 0 010-1.113zM17.25 12a5.25 5.25 0 11-10.5 0 5.25 5.25 0 0110.5 0z"
                    clipRule="evenodd"
                  />
                </svg>
              </button>
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <label htmlFor="companyDetails">
              Add company details{" "}
              <span className="inline-flex justify-center items-center w-4 h-4 text-xs border border-gray-400 rounded-full text-gray-500 cursor-pointer">
                i
              </span>
            </label>
          </div>
