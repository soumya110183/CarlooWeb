      ...
      <div className="w-full max-w-4xl p-8 bg-[#0F092A] rounded-xl shadow-2xl mx-auto mt-10">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-[#B7B6C0]">
                Your Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-[#B7B6C0]">
                Your Email
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-medium text-[#B7B6C0]">
                Phone Number
              </label>
              <input
                type="tel"
           ...
           <label htmlFor="subject" className="block text-sm font-medium text-gray-300">
              ...
              <select
                ...
                onChange={handleChange}
                className="mt-1 block w-full  text-white border-b border-gray-600 focus:outline-none focus:border-purple-500 py-2 placeholder-gray-500 transition-colors duration-200"
                required
              >
          ...
          <div className="mt-6">
            <label htmlFor="message" className="block text-sm font-medium text-[#B7B6C0]">
              Message
            </label>
            <textarea
              id="message"
