...
export default function page() {
  return (
    <div className="mt-50 text-foreground overflow-y-hidden px-10 max-sm:px-5 ">
      ...
      <Underline />
      <ParagraphReUse paragraph={"Carlo PEaaS: Ethical AI and Data Protection Compliance with Global Standards like GDPR, CCPA, and the EU AI Act."} center={true}/>
