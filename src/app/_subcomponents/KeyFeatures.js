export default function KeyFeatures({features}){
    ...
    return (
            <div className={`w-full max-w-[1000px] flex ${features.flex ? "flex-row-reverse":""} items-center mx-auto justify-between gap-4`}>
                <div className="mt-5">
  ...
  {features.heading}
    ...
    <p className="text-[22px] w-full max-w-[488px] font-medium mt-5">{features.paragraph}
