  ...
  const regionPopupData = {
    "North America": {
      ...
      frameworks: [
        ...
        { name: "Algorithmic Accountability Act", description: "A bill to regulate AI decision-making transparency" }
      ],
      howCarloHelps: "Carlo automates compliance with U.S. and Canadian data laws."
    },
    Europe: {
      ...
      frameworks: [
        ...
        { name: "EU AI Act", description: "AI regulation proposed by the European Commission" },
        { name: "Ethics Guidelines for Trustworthy AI", description: "EU’s ethical framework for AI systems" }
      ],
      howCarloHelps: "Carlo ensures end-to-end compliance with GDPR and EU AI guidelines."
    },
    "Asia-Pacific": {
      ...
      frameworks: [
        ...
        { name: "Japan AI Guidelines", description: "Governance framework for AI usage" }
      ],
      howCarloHelps: "Carlo localizes compliance to each country's data protection requirements."
    },
    Africa: {
      ...
      frameworks: [
        ...
        { name: "AU AI Strategy", description: "African Union Artificial Intelligence Strategy" }
      ],
      howCarloHelps: "Carlo supports privacy and AI governance across the African continent."
    },
    "Latin America": {
      ...
      frameworks: [
        ...
        { name: "Mexico Data Laws", description: "Mexico’s Federal Data Protection Law" }
      ],
      howCarloHelps: "Carlo ensures seamless compliance with Latin American privacy laws."
    },
    "Middle East": {
      ...
      howCarloHelps: "Carlo aligns AI and data practices with GCC privacy and data protection norms."
    }
  };
