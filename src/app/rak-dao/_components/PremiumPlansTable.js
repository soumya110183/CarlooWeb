...
const premiumPlansData = [
  ...
  },
  {
    ...
    monthlyUSD: "~26.20",
    includes:
      "Full dashboard, basic smart contract scans, UAE+EU compliance tracking",
  },
  {
    ...
    monthlyUSD: "~43.70",
    includes:
      "DeFi risk monitoring, explainability checks, token governance insights",
  },
  {
    ...
    monthlyUSD: "~49.00",
    includes:
      "Dedicated advisor, quarterly deep audits, global framework integration",
  },
];

const PremiumPlansTable = () => {
  return (
    <div className=" font-sans text-gray-200 mt-10 pb-32">
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-[#5d3fd3] text-white text-sm font-semibold uppercase tracking-wider">
              <th className="py-4 px-6 text-left border-r border-gray-600">
                Plan
              </th>
              <th className="py-4 px-6 text-left border-r border-gray-600">
                Ideal For
              </th>
              <th className="py-4 px-6 text-center border-r border-gray-600">
                Monthly (AED)
              </th>
              <th className="py-4 px-6 text-center border-r border-gray-600">
                Monthly (USD)
      ...
      <p className="md:text-[22px] text-base sm:text-[18px]  text-center w-full mt-10 max-sm:mt-4 text-foreground">
        <strong>Bonus:</strong> Every paid plan includes a 20% discount if you
        incorporate through Algorethics.
      </p>
    </div>
  );
};
