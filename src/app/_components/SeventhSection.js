export default function SeventhFunction(){
    return(
        <section>
          <div
  className="w-full max-w-[1000px] h-[502px] mx-auto rounded-[50px] mt-[222px]"
  style={{
    background: "linear-gradient(173deg, rgba(138, 252, 253, 1) 0%, rgba(227, 199, 217, 1) 100%)",
...
>
  ...
  <h3 className="font-bold text-[48px] text-center text-black">Experience Compliance,<br/>Effortlessly</h3>
...
<button className="p-2.5 bg-black rounded-[37px] ">START FREE TRIAL</button>
<button className="p-2.5 bg-transparent border-2 borderblack text-black rounded-[37px]">TALK TO A COMPLIANCE SUPPORT </button>
</div>
