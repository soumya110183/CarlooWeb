...
return(
    <section>
        <div className="w-full max-w-[1200px] flex mx-auto mt-36 justify-between">
...
Deliver Results
        ...
        <div className="w-24 h-3 rounded-full bg-gradient-to-r from-pink-300 via-cyan-300 to-pink-200"></div>
            ...
            <p className="w-full text-[16px] font-medium mt-2">AI (Artifical Intelligence) and ML (MachineLearning) are closely related fields that arefocused on the development of computersystems that can perform tasks that would normally require human
intelligence, suchlanguage</p>
            </div>
            <div className="w-full max-w-[570px]">
<Percentage />
<div className="flex items-center w-full justify-between mt-3.5">
<div>
<h3 className="font-bold text-[24px]">Have any question about us?</h3>
<p className="text-[16px] font-medium">Don't hesitate to contact us. Contact Us</p>
</div>
