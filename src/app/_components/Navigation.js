      ...
      >
        ...
        <div className="flex items-center gap-10">
            ...
            {[
              ...
              >
                <span className="hover:text-[#C7BFE9] transition-all duration-300 flex items-center gap-2">
                  {item}
                   {(item === "Compliance Frameworks" || item === "Resources") && (
          <img
            src="/Vector.png"
            alt="dropdown icon"
          ...
          />
              ...
              {resourcesOpen && item === "Resources" && <DropDownMenuResources dropdownOpen={resourcesOpen} />}
        ...
        <button><img src="/material-symbols_settings.svg" alt="settings" className="w-[29px]"/></button>
      </nav>
