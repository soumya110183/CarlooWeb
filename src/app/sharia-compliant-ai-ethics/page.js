...
export default function page() {
  return (
    <div className="mt-50 text-foreground max-w-[1200px] mx-auto max-lg:flex-col sm:px-10 px-5">
      ...
      <Underline />
      <ParagraphReUse paragraph={"Carlo PEaaS: Ethical AI and Data Protection Compliance with Global Standards like GDPR, CCPA, and the EU AI Act Carlo PEaaS Enforcing Sharia-Compliant AI Ethics in the Modern World"} center={true}/>
